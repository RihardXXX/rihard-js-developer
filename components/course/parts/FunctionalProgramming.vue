...
<template>
  <section :id="FUNCTIONAL_PROGRAMMING">
      ...
      <Description>
        <p>
          <strong>Функциональное программирование</strong> - это высокоуровневая декларативная разработка на основе
        ...
        <p>
          <strong>Чистые функции</strong> - это функции, которые при и одних и тех же аргументах возвращают
