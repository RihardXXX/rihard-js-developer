  ...
  <section ref="aboutMe" :class="['container', $style.aboutMe]">
    ...
    >
      <VInfo
        ...
        description="Меня зовут Рихард Алиханов, я люблю писать код. Уже больше 5 лет я помогаю бизнесу
        решать их проблемы с помощью моего кода. Участвовал в разных высоко нагруженных проектах. Люблю Frontend ))"
