  ...
  <section :id="FUNCTION_MAP_FILTER_REDUCE">
    ...
    // ===================================
      ...
      <Description>
        ...
        <p>
          Функция <strong>reduce</strong> возвращает любой тип данных,
          она в качестве аргументов принимает функцию и аккумулятор.
        </p>
        <p>
          Функция в качестве аргумента принимает аккумулятор (инициализации или последующих вызовов)
          и текущий элемент, пропускает через логику функции эти данные и возвращает
          новый аккумулятор или вносят в текущий аккумулятор изменения.
          </p>
        <p>
          Аккумулятором (значением при инициализации) может быть любое значение.
        </p>
        <p>
          Функцией <strong>reduce</strong> можно сымитировать любое кастомное поведение,
          а также поведение map and filter. Но обычно оно используется для сбора, конкретно
          каких то данных по определенной логике из итерируемого типа объекта.
        </p>
      </Description>
      <CodeBlock v-if="device.mobile">
        <template #default>
